...
var AudioplayPage = /** @class */ (function () {
    function AudioplayPage(navCtrl, viewCtrl, translateService, media, angFire, _audioProvider, navParams, modalCtrl) {
        this.navCtrl = navCtrl;
